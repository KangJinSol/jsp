...
CREATE SEQUENCE BNO_SEQ START WITH 392 INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 20;

   CREATE SEQUENCE  BOARD_COMMENT_SEQ START WITH 73 MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1  CACHE 30 NOORDER  NOCYCLE ;
CREATE SEQUENCE  QNO_SEQ  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE ;
select * from board where bno = 390
© 2021 GitHub, Inc.